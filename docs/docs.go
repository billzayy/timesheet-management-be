    ...
    "paths": {
        ...
        "/branch/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Branch Information",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/level/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Level Information",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.LevelDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/level/delete": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Delete Level Information",
                        "name": "id",
                        "in": "query",
                        "required": true
                    }
        ...
        "/user-type/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "UserType Information",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UserTypeDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Send Request Create User",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RequestUserDTO"
                        }
                    }
                ],
                "responses": {
